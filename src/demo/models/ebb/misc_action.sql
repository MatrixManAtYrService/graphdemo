...
`id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `misc_action_fee_code_uuid` char(26) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `misc_action_key1` (`uuid`),
  UNIQUE KEY `misc_action_key2` (`billing_entity_uuid`,`date_to_post`,`fee_uuid`,`fee_category`,`fee_code`,`uuid`),
  UNIQUE KEY `misc_action_key3` (`request_uuid`,`billing_entity_uuid`,`uuid`),
  KEY `misc_action_key4` (`fee_uuid`,`action_datetime`)
);