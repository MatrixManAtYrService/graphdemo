CREATE TABLE `plan_action_error` (
`id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(26) NOT NULL,
  `plan_action_uuid` char(26) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `plan_action_error_key1` (`uuid`),
  UNIQUE KEY `plan_action_error_key2` (`plan_action_uuid`,`id`),
  UNIQUE KEY `plan_action_error_key3` (`request_uuid`,`posting_date`,`plan_action_uuid`,`id`)
);