...
class MinimalAppSubActionMixin:
...
class AppSubAction(BaseModel, MinimalAppSubActionMixin):
    """
    Pydantic V2 model for the `app_sub_action` table.
    """
    id: int = Field(..., description="Primary key, auto-incrementing.", gt=0)
    uuid: str = Field(..., max_length=26, description="Unique identifier for the app sub action.")
    ...
    app_sub_action_type: str = Field(..., max_length=25, description="Type of app sub action.")
    ...
    app_sub_action_fee_code_uuid: Optional[str] = Field(default=None, max_length=26, description="UUID for the app sub action fee code.")
    ...
    class Config:
        ...
        json_schema_extra = {
            "example": {
                ...
                "app_subscription_uuid": "01H8X7Y7Z7QWR",
                "app_sub_action_type": "SUBSCRIPTION_BILLING",
                ...
                "basis_amount": "29.990",
                "basis_currency": "USD",
                "reference": "Monthly App Subscription",
                "app_sub_action_fee_code_uuid": "01H8X7Y7Z7QWERTYUIOPASDFGA",
...
if __name__ == "__main__":
    example_dict = AppSubAction.model_json_schema().get("example", {})
    app_sub_action_instance = AppSubAction(**example_dict)
    print("----begin example: app-sub-action----")
    print(app_sub_action_instance.model_dump_json(indent=2))
    print("----begin minmal example: app-sub-action----")
    print(json.dumps(app_sub_action_instance.to_minimal_dict(), indent=2))

    print("----end: app-sub-action----")