CREATE TABLE `misc_action_error` (
`id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `uuid` char(26) NOT NULL,
  `misc_action_uuid` char(26) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `misc_action_error_key1` (`uuid`),
  UNIQUE KEY `misc_action_error_key2` (`misc_action_uuid`,`id`),
  UNIQUE KEY `misc_action_error_key3` (`request_uuid`,`posting_date`,`misc_action_uuid`,`id`)
);