CREATE TABLE `cellular_action_fee_code` (
`id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `cellular_action_fee_code_key1` (`uuid`),
  UNIQUE KEY `cellular_action_fee_code_key2` (`carrier`,`merchant_plan_uuid`,`cellular_action_type`,`effective_date`)
);